...
puts "Il y a #{journalistesmaj.length} handles qui contiennent une majuscule"
n = 0
journalistes.each do |m|
    letters=m.chars
...
puts "Voici la liste dans l'ordre alaphabétique"
sorted_journalistes=journalistes.sort_by {|alph| alph.downcase}
print sorted_journalistes